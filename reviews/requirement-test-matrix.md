...
| requirement-operator-readable-error | shell | TP-GROK-CLI-25* · TP-VCLI-16 · TP-VCLI-19 | Operator-facing `[ERROR]` |
...
| requirement-shell-cli-storage | shell | TP-CLI-**06**, **12** · TP-VCLI-15 | Cache `/dev/shm/cache/cache-${APP_NAME}` + persistence `${HOME}/.local/${APP_NAME}`; Termux cache may be `noexec` |
