...
| L-PROMPT-CAPTURE-01 | TTY menu pick 4 hangs because `_spec=$(prompt_ask …)` swallows the prompt | **MUST NOT** `$()` `prompt_ask` / any `read` helper; current-shell `PROMPT_ASK_VALUE`; TP-CLI-15 · TP-GROK-CLI-34; mold §8.1.5; INC-20260902-001 | open watch |
