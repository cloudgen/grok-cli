...
**Updated:** 2026-09-07 (25 Active + 4 superseded; version-aware self-update 1.1.0)
...
| requirement-shell-self-management | `version-check` / `self-update` / `self-uninstall`; proceeding `self-update` first INFO names local and remote VERSION | shell | Active (1.1.0) | `requirement-shell-self-management.md` | 2026-09-07 |
