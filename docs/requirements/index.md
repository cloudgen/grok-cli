...
**Updated:** 2026-08-30 (19 Active + 4 superseded)
...
| requirement-shell-cli-interface | Shell CLI interface (commands, flags, dispatch, modes); generate-sudoer-request; check-session / backup / sync-auth; empty argv → `app_default`; about Cache folder + Persistence storage | shell | Active (2.3.2) | `requirement-shell-cli-interface.md` | 2026-08-30 |
