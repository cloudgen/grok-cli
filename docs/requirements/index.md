...
**Updated:** 2026-09-07 (25 Active + 4 superseded)
...
| requirement-shell-termux-coding | Termux/Android host writing: honor `PREFIX`, Termux `pkg` (no sudo), `noexec` tmp, FHS-not-assumed; session probe exec always bounded (`timeout -k` / watchdog); points at setup/folder/storage/auth | shell | Active (1.2.0) | `requirement-shell-termux-coding.md` | 2026-09-07 |
