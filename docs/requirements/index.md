...
|----------|-------|------|--------|------|---------|
| requirement-class-software-dev | Software-development class law + residual stack (posix-sh, dual-mode); residual no dest approver / no dest fence; §1.1 | class | Active (1.3.0) | `requirement-class-software-dev.md` | 2026-09-02 |
